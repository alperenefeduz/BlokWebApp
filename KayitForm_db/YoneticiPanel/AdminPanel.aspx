<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminPanel.aspx.cs" Inherits="KayitForm_db.AdminPanel" %>
    ...
    <form id="form1" runat="server">
        <div class="anaTasiyici golge">
            ...
            <div class="sag">
                ...
                <div class="satir">
                    <asp:Button ID="btn_giris" runat="server" Text="Giriş Yap" CssClass="buton" OnClick="btn_giris_Click" k />
                </div>
